public class PokerHand implements Comparator<PokerHand> {
  ...
  public int compare(PokerHand o1, PokerHand o2, PokerHand n) {
    if (n.choice1) {
      if (n.choice2) {
        ...
        if ((o2.indexOf(4) != -1) || (o1.indexOf(4) != -1)) {  // Four of a kind
            if (o2.indexOf(4) == o1.indexOf(4)) {
                int i1 = 0;
                while(i1 <= 12){
                    if ((o2.charAt(i1) != 0) && (o2.charAt(i1) != 4) && (!(o1.charAt(i1) != 0) || !(o1.charAt(i1) != 4))) {
                        return 1;
                    }
                    if ((o2.charAt(i1) != 0) && (o2.charAt(i1) != 4)) {
                        return 0;
        ...
        if ((tripleCount1 > 1) || ((tripleCount1 == 1) && (o1.indexOf(2) != -1))) {      // c1 Full house
            if ((tripleCount2 > 1) || ((tripleCount2 == 1) && (o2.indexOf(2) != -1))) {  // c2 Full house too
                ...
                if (higherTriple == o1.lastIndexOf(3)) {
                    int i2=0;
                    while(i2 <= 12){
                        if ((i2 != higherTriple) && (((o1.charAt(i2) == 2) || (o1.charAt(i2) == 3)) && ((o2.charAt(i2) == 2) || (o2.charAt(i2) == 3)))) {
                            return 0;
                ...
                return o1.lastIndexOf(3) - higherTriple;
            }
            return 1;
        }
        if ((tripleCount2 > 1) || ((tripleCount2 == 1) && (o2.indexOf(2) != -1))) {
        ...
        if ((o2.indexOf(4) != -1) || (o1.indexOf(4) != -1)) {  // Four of a kind
            ...
            return -(o2.indexOf(4) - o1.indexOf(4));
        }
        int tripleCount1 = o1.countOccurrencesOf(3);
        int tripleCount2 = o2.countOccurrencesOf(3);
        ...
        if ((tripleCount1 > 1) || ((tripleCount1 == 1) && (o1.indexOf(2) != -1))) {      // c1 Full house
            if ((tripleCount2 > 1) || ((tripleCount2 == 1) && (o2.indexOf(2) != -1))) {  // c2 Full house too
                ...
                return -(higherTriple - o1.lastIndexOf(3));
            }
            return 1;
        }
        if ((tripleCount2 > 1) || ((tripleCount2 == 1) && (o2.indexOf(2) != -1))) {
